...
!(function (t, e) {
  ...
  var _ =
    ...
    (function (t) {
      ...
      try {
        N.apply((P = O.call(w.childNodes)), w.childNodes),
        ...
        return (
          ...
          ut(function (o, a, s, l) {
            var u,
              ...
              v = n ? (r || (o ? t : p || i) ? [] : a) : m;
            if ((n && n(m, v, s, l), i))
              for (u = kt(v, f), i(u, [], s, l), c = u.length; c--; )
                (d = u[c]) && (v[f[c]] = !(m[f[c]] = d));
            if (o) {
              if (r || t) {
                if (r) {
  ...
  (w.filter = function (t, e, n) {
    ...
    w.fn.extend({
      ...
      is: function (t) {
        return !!D(this, "string" == typeof t && S.test(t) ? w(t) : t || [], !1)
          .length;
      },
    });
  var P,
      ...
      function (t, e) {
        w.fn[t] = function (n, i) {
          ...
          return (
            ...
            this.length > 1 &&
              (N[t] || w.uniqueSort(r), L.test(t) && r.reverse()),
            this.pushStack(r)
          );
        };
      }
  ...
  (w.Callbacks = function (t) {
    ...
    w.extend({
        ...
        var n = [
          ...
          r = {
            ...
            then: function (e, i, r) {
              ...
              return w
                .Deferred(function (t) {
                  n[0][3].add(a(0, t, p(r) ? r : F, t.notifyWith)),
                    n[1][3].add(a(0, t, p(e) ? e : F)),
                    n[2][3].add(a(0, t, p(i) ? i : R));
                })
                .promise();
            },
            promise: function (t) {
      ...
      when: function (t) {
        ...
        if (
          e <= 1 &&
          (j(t, a.done(s(n)).resolve, a.reject, !e),
    ...
    w.fn.extend({
      data: function (t, e) {
        ...
        if (void 0 === t) {
          if (
            this.length &&
            ((r = K.get(o)), 1 === o.nodeType && !G.get(o, "hasDataAttrs"))
          ) {
            for (n = a.length; n--; )
              a[n] &&
  ...
  function xt(t, e, n, i, r) {
    ...
    for (d.textContent = "", f = 0; (o = h[f++]); )
      if (i && w.inArray(o, i) > -1) r && r.push(o);
        ...
        ((u = rt(o)), (a = vt(d.appendChild(o), "script")), u && bt(a), n)
      )
          ...
          handler: function (t) {
            ...
            if (1 & t.isTrigger && this[e]) {
              if (a.length)
                ...
                (i = n(this, e)),
                this[e](),
                a !== (o = G.get(this, e)) || i ? G.set(this, e, !1) : (o = {}),
                a !== o)
              )
                return (
  ...
  (w.event = {
    ...
    dispatch: function (t) {
      ...
      if (
        ...
        for (
          a = w.event.handlers.call(this, l, u), e = 0;
    ...
    handlers: function (t, e) {
      ...
      return (
        (u = this), l < e.length && s.push({ elem: u, handlers: e.slice(l) }), s
      );
    },
    ...
    special: {
      ...
      click: {
        setup: function (t) {
          var e = this || t;
          return (
            ft.test(e.type) && e.click && T(e, "input") && St(e, "click", kt),
            !1
          );
        },
        trigger: function (t) {
          var e = this || t;
          return (
            ft.test(e.type) && e.click && T(e, "input") && St(e, "click"), !0
          );
        },
        _default: function (t) {
          var e = t.target;
  ...
  function Et(t, e, n, i) {
    ...
    var r,
      ...
      m = e[0],
      v = p(m);
    if (v || (h > 1 && "string" == typeof m && !f.checkClone && At.test(m)))
    ...
    if (
      h &&
      ((a = (r = xt(e, t[0].ownerDocument, !1, t, i)).firstChild),
      1 === r.childNodes.length && (r = a),
      a || i)
    ) {
      for (l = (s = w.map(vt(r, "script"), It)).length; d < h; d++)
        (u = r),
          d !== g &&
            ((u = w.clone(u, !0, !0)), l && w.merge(s, vt(u, "script"))),
          n.call(t[d], u, d);
      if (l)
        for (c = s[s.length - 1].ownerDocument, w.map(s, Lt), d = 0; d < l; d++)
          (u = s[d]),
            gt.test(u.type || "") &&
              ...
              (u.src && "module" !== (u.type || "").toLowerCase()
                ...
                : b(u.textContent.replace(Dt, ""), u, c));
    }
    return t;
  }
  function Ft(t, e, n) {
    for (var i, r = e ? w.filter(e, t) : t, o = 0; null != (i = r[o]); o++)
      n || 1 !== i.nodeType || w.cleanData(vt(i)),
        i.parentNode &&
          (n && rt(i) && bt(vt(i, "script")), i.parentNode.removeChild(i));
    return t;
  }
  w.extend({
    ...
    clone: function (t, e, n) {
      ...
      if (
        ...
        for (a = vt(s), i = 0, r = (o = vt(t)).length; i < r; i++)
          Ot(o[i], a[i]);
      if (e)
        if (n)
          for (o = o || vt(t), a = a || vt(s), i = 0, r = o.length; i < r; i++)
            Nt(o[i], a[i]);
        else Nt(t, s);
      return (
        (a = vt(s, "script")).length > 0 && bt(a, !l && vt(t, "script")), s
      );
    },
  ...
  function Zt(t, e, n, i, r, o) {
    ...
    for (; a < 4; a += 2)
      "margin" === n && (l += w.css(t, n + nt[a], !0, r)),
        i
          ? ("content" === n && (l -= w.css(t, "padding" + nt[a], !0, r)),
            "margin" !== n &&
              (l -= w.css(t, "border" + nt[a] + "Width", !0, r)))
          : ((l += w.css(t, "padding" + nt[a], !0, r)),
            "padding" !== n
              ? (l += w.css(t, "border" + nt[a] + "Width", !0, r))
              : (s += w.css(t, "border" + nt[a] + "Width", !0, r)));
    return (
      !i &&
        o >= 0 &&
        (l +=
  ...
  function Jt(t, e, n) {
    ...
    return (
      ((!f.boxSizingReliable() && r) ||
        ...
        (o = s in t) && (a = t[s])),
      (a = parseFloat(a) || 0) +
        Zt(t, e, n || (r ? "border" : "content"), o, i, a) +
        "px"
    );
  }
    ...
    style: function (t, e, n, i) {
      if (t && 3 !== t.nodeType && 8 !== t.nodeType && t.style) {
        var r,
          ...
          u = t.style;
        if (
          (l || (e = Yt(s)), (a = w.cssHooks[e] || w.cssHooks[s]), void 0 === n)
        )
        ...
        return H(
          ...
          function (t, e, n) {
            var i,
              ...
              a = 0;
            if (Array.isArray(e)) {
              for (i = jt(t), r = e.length; a < r; a++)
                o[e[a]] = w.css(t, e[a], !1, i);
              return o;
            }
        ...
        if ((l = !w.isEmptyObject(e)) || !w.isEmptyObject(f))
          ...
          f))
            l ||
              ...
              g && ct([t], !0),
              h.done(function () {
                for (i in (g || ct([t]), G.remove(t, "fxshow"), f))
                  w.style(t, i, f[i]);
              })),
              (l = le(g ? m[i] : 0, i, h)),
              i in m ||
      ...
      stop: function (t, e, n) {
        ...
        return (
          ...
          this.each(function () {
            ...
            else for (r in a) a[r] && a[r].stop && re.test(r) && i(a[r]);
            for (r = o.length; r--; )
              o[r].elem !== this ||
                (null != t && o[r].queue !== t) ||
    ...
    w.extend({
      prop: function (t, e, n) {
        ...
        if (3 !== o && 8 !== o && 2 !== o)
          return (
            (1 === o && w.isXMLDoc(t)) ||
              ((e = w.propFix[e] || e), (r = w.propHooks[e])),
            void 0 !== n
              ? r && "set" in r && void 0 !== (i = r.set(t, n, e))
                ? i
                : (t[e] = n)
    ...
    w.extend({
      valHooks: {
        ...
        select: {
          ...
          set: function (t, e) {
            for (
              var n, i, r = t.options, o = w.makeArray(e), a = r.length;
              a--;
  ...
  w.extend(w.event, {
    trigger: function (e, n, i, r) {
      ...
      if (
        ...
        3 !== i.nodeType &&
          8 !== i.nodeType &&
          !be.test(b + w.event.triggered) &&
          (b.indexOf(".") > -1 &&
            ((y = b.split(".")), (b = y.shift()), y.sort()),
          (u = b.indexOf(":") < 0 && "on" + b),
          ((e = e[w.expando]
            ? e
            : new w.Event(b, "object" == typeof e && e)).isTrigger = r ? 2 : 3),
          (e.namespace = y.join(".")),
        ...
        if (!r && !h.noBubble && !g(i)) {
          for (
            l = h.delegateType || b, be.test(l + b) || (a = a.parentNode);
            a;
            a = a.parentNode
          )
            v.push(a), (s = a);
          s === (i.ownerDocument || m) &&
            v.push(s.defaultView || s.parentWindow || t);
        }
        for (o = 0; (a = v[o++]) && !e.isPropagationStopped(); )
          (f = a),
            (e.type = o > 1 ? l : h.bindType || b),
            (d =
              (G.get(a, "events") || Object.create(null))[e.type] &&
              G.get(a, "handle")) && d.apply(a, n),
            (d = u && a[u]) &&
              d.apply &&
              $(a) &&
        ...
        return (
          ...
          r ||
            ...
            (u &&
              ...
              ((s = i[u]) && (i[u] = null),
              (w.event.triggered = b),
              e.isPropagationStopped() && f.addEventListener(b, ye),
              i[b](),
              e.isPropagationStopped() && f.removeEventListener(b, ye),
      ...
      w.each({ focus: "focusin", blur: "focusout" }, function (t, e) {
        ...
        w.event.special[e] = {
          ...
          teardown: function () {
            ...
            r
              ? G.access(i, e, r)
              : (i.removeEventListener(t, n, !0), G.remove(i, e));
          },
        };
      });
  var xe = t.location,
            ...
            d
              ? (f.ifModified &&
                  ((k = C.getResponseHeader("Last-Modified")) &&
                    (w.lastModified[r] = k),
                  (k = C.getResponseHeader("etag")) && (w.etag[r] = k)),
                204 === e || "HEAD" === f.type
                  ? (_ = "nocontent")
                  : 304 === e
                  ? (_ = "notmodified")
                  : ((_ = x.state), (h = x.data), (d = !(m = x.error))))
              : ((m = _), (!e && _) || ((_ = "error"), e < 0 && (e = 0))),
            (C.status = e),
            (C.statusText = (n || _) + ""),
            d ? v.resolveWith(p, [h, _, C]) : v.rejectWith(p, [C, _, m]),
            C.statusCode(y),
            (y = void 0),
            c && g.trigger(d ? "ajaxSuccess" : "ajaxError", [C, f, d ? h : m]),
            b.fireWith(p, [C, _]),
            c &&
  ...
  w.ajaxSetup({
    ...
    w.ajaxPrefilter("json jsonp", function (e, n, i) {
      ...
      if (s || "jsonp" === e.dataTypes[0])
        return (
          ...
          s
            ? (e[s] = e[s].replace(Ue, "$1" + r))
            : !1 !== e.jsonp &&
              (e.url += (ke.test(e.url) ? "&" : "?") + e.jsonp + "=" + r),
    ...
    (f.createHTMLDocument =
      (((Ve = m.implementation.createHTMLDocument("").body).innerHTML =
        "<form></form><form></form>"),
    ...
    (w.fn.load = function (t, e, n) {
      var i,
        ...
        s = t.indexOf(" ");
      return (
        s > -1 && ((i = pe(t.slice(s))), (t = t.slice(0, s))),
        p(e)
          ? ((n = e), (e = void 0))
    ...
    w.each(["top", "left"], function (t, e) {
      w.cssHooks[e] = Ht(f.pixelPosition, function (t, n) {
        if (n)
          return (n = Wt(t, e)), Rt.test(n) ? w(t).position()[e] + "px" : n;
      });
    }),
  ...
  (function (t, e) {
      ...
      n = (function (t, e) {
        ...
        (r.rgb.hsl = function (t) {
          ...
          (r.hcg.rgb = function (t) {
            ...
            return (
              (r = (1 - n) * i),
              [255 * (n * o[0] + r), 255 * (n * o[1] + r), 255 * (n * o[2] + r)]
            );
          }),
    ...
    function i(t) {
      var e = (function () {
          for (var t = {}, e = Object.keys(n), i = e.length, r = 0; r < i; r++)
      ...
      for (e[t].distance = 0; i.length; )
        for (
          var r = i.pop(), o = Object.keys(n[r]), a = o.length, s = 0;
          s < a;
          s++
        ) {
          var l = o[s],
            u = e[l];
          -1 === u.distance &&
            ((u.distance = e[r].distance + 1), (u.parent = r), i.unshift(l));
        }
      return e;
    }
    function r(t, e) {
    ...
    function o(t, e) {
      for (
        var i = [e[t].parent, t], o = n[e[t].parent][t], a = e[t].parent;
        e[a].parent;

      )
        i.unshift(e[a].parent),
          (o = r(n[e[a].parent][a], o)),
          (a = e[a].parent);
    ...
    Object.keys(n).forEach(function (t) {
      (a[t] = {}),
        Object.defineProperty(a[t], "channels", { value: n[t].channels }),
        Object.defineProperty(a[t], "labels", { value: n[t].labels });
      var e = (function (t) {
        for (
          var e = i(t), n = {}, r = Object.keys(e), a = r.length, s = 0;
          s < a;
          s++
        ) {
          var l = r[s];
    ...
    (x.prototype = {
      ...
      (x.prototype.setValues = function (t, e) {
        ...
        for (n = 0; n < t.length; n++)
          (i = Math.max(0, Math.min(a[t][n], r[t][n]))),
            (r[t][n] = Math.round(i));
      ...
      C = {
        ...
        each: function (t, e, n, i) {
          ...
          if (C.isArray(t))
            ...
            for (o = (a = Object.keys(t)).length, r = 0; r < o; r++)
              e.call(n, t[a[r]], a[r]);
        },
        ...
        _mergerIf: function (t, e, n) {
          if (k(t)) {
            var i = e[t],
              r = n[t];
            C.isObject(i) && C.isObject(r)
              ? C.mergeIf(i, r)
              : e.hasOwnProperty(t) || (e[t] = C.clone(r));
          }
        },
        merge: function (t, e, n) {
          ...
          for (i = (n = n || {}).merger || C._merger, r = 0; r < u; ++r)
            if (((e = l[r]), C.isObject(e)))
              for (s = 0, a = (o = Object.keys(e)).length; s < a; ++s)
                i(o[s], t, e, n);
          return t;
        },
            ...
            t.moveTo(e, l),
              s < u && l < c
                ...
                ? (t.moveTo(s, n),
                  ...
                  t.arc(s, l, a, I, A + I))
                : l < c
                ? (t.arc(s, l, a, -A, 0), t.arc(s, c, a, 0, A))
                : t.arc(s, l, a, -A, A),
              t.closePath(),
              t.moveTo(e, n);
          } else t.rect(e, n, i, r);
            ...
            switch ((t.beginPath(), e)) {
              ...
              case "rectRounded":
                (u = n - (c = 0.516 * n)),
                  (s = Math.cos(d + L) * u),
                  (l = Math.sin(d + L) * u),
                  t.arc(i - s, r - l, c, d - A, d - I),
                  t.arc(i + l, r - s, c, d - I, d),
                  t.arc(i + s, r + l, c, d, d + I),
                  t.arc(i - l, r + s, c, d + I, d + A),
                  t.closePath();
                break;
              case "rect":
                if (!o) {
        ...
        resolve: function (t, e, n, i) {
          ...
          for (r = 0, o = t.length; r < o; ++r)
            if (
              ...
              void 0 !== n && M.isArray(a) && ((a = a[n]), (s = !1)),
              void 0 !== a)
            )
      ...
      _resolveDataElementOptions: function (t, e) {
        ...
        if (((i = i || {}), H.isArray(h)))
          for (a = 0, s = h.length; a < s; ++a)
            f[(l = h[a])] = Z([i[l], c[l], d[l]], p, e, g);
        else
          for (a = 0, s = (o = Object.keys(h)).length; a < s; ++a)
            f[(l = o[a])] = Z([i[l], c[h[l]], c[l], d[l]], p, e, g);
          ...
          if (s.length) {
            ...
            for (
              o.save(),
                ...
                o.lineDashOffset = at(r.borderDashOffset, u.borderDashOffset),
                o.lineJoin = r.borderJoinStyle || u.borderJoinStyle,
                o.lineWidth = at(r.borderWidth, u.borderWidth),
                o.strokeStyle = r.borderColor || l.defaultColor,
                o.beginPath(),
                (n = s[0]._view).skip || (o.moveTo(n.x, n.y), (c = 0)),
                t = 1;
              t < s.length;
              ++t
            )
              (n = s[t]._view),
                (e = -1 === c ? H.previousItem(s, t) : s[c]),
                n.skip ||
                  ((c !== t - 1 && !a) || -1 === c
                    ? o.moveTo(n.x, n.y)
                    : H.canvas.lineTo(o, e._view, n),
                  (c = t));
        ...
        draw: function (t) {
          ...
          e.skip ||
            ((void 0 === t || H.canvas._isPointInArea(e, t)) &&
              ...
              (n.lineWidth = ut(e.borderWidth, l.elements.point.borderWidth)),
              (n.fillStyle = e.backgroundColor || u),
              H.canvas.drawPoint(n, i, o, a, s, r)));
        },
      }),
    ...
    var St = nt.extend({
        ...
        updateElement: function (t, e, n) {
          ...
          (t._xScale = i.getScaleForId(r.xAxisID)),
            ...
            H.isArray(o.data[e]) && (t._model.borderSkipped = null),
        ...
        calculateBarValuePixels: function (t, e, n) {
          var i,
            ...
            y =
              void 0 === g.start ? 0 : g.max >= 0 && g.min >= 0 ? g.min : g.max,
            x =
              void 0 === g.start
                ? g.end
                : g.max >= 0 && g.min >= 0
              ...
              r.stack === b &&
                ((o =
                  void 0 === (u = d._parseValue(f[r.index].data[e])).start
                    ...
                    ? u.max
                    : u.min),
                ((g.min < 0 && o < 0) || (g.max >= 0 && o > 0)) && (y += o));
          return (
            (a = d.getPixelForValue(y)),
            (l = (s = d.getPixelForValue(y + x)) - a),
            void 0 !== m &&
              Math.abs(l) < m &&
              ((l = m), (s = (x >= 0 && !h) || (x < 0 && h) ? a - m : a + m)),
    ...
    R._set("doughnut", {
      ...
      legendCallback: function (t) {
        ...
        if ((r.setAttribute("class", t.id + "-legend"), a.length))
          for (e = 0, n = a[0].data.length; e < n; ++e)
            ((i = r.appendChild(document.createElement("li"))).appendChild(
              document.createElement("span")
            ).style.backgroundColor = a[0].backgroundColor[e]),
        ...
        var i = this,
          ...
          f =
            (n && s.animateRotate) || t.hidden
              ? 0
              : i.calculateCircumference(h.data[e]) * (a.circumference / Lt),
      ...
      getMaxBorderWidth: function (t) {
        ...
        for (e = 0, n = t.length; e < n; ++e)
          (r = t[e]),
            ...
            "inner" !== a.borderAlign &&
              ((s = a.borderWidth),
              (u = (l = a.hoverBorderWidth) > (u = s > u ? s : u) ? l : u));
        return u;
      },
      setHoverStyle: function (t) {
        var e = t._model,
    ...
    var Ht = nt.extend({
        ...
        _resolveDatasetElementOptions: function (t) {
          ...
          return (
            (a.spanGaps = Ft(n.spanGaps, r.spanGaps)),
            (a.tension = Ft(n.lineTension, o.tension)),
            (a.steppedLine = Rt([i.steppedLine, n.steppedLine, o.stepped])),
            (a.clip = Wt(Ft(n.clip, Bt(e._xScale, e._yScale, a.borderWidth)))),
            a
          );
        },
        calculatePointY: function (t, e, n) {
          ...
          if (d.options.stacked) {
            for (
              ...
              (r = c.data.datasets[o.index]),
                "line" === o.type &&
                  o.yAxisID === d.id &&
                  ((a = +d.getRightValue(r.data[e])) < 0
                    ? (f += a || 0)
                    : (h += a || 0));
            return s < 0
        ...
        setHoverStyle: function (t) {
          ...
          (t.$previousStyle = {
            ...
            (e.radius = Ft(n.hoverRadius, n.radius));
        },
      }),
    ...
    R._set("pie", H.clone(R.doughnut)), R._set("pie", { cutoutPercentage: 0 });
    var Ut = Ot,
      Yt = H.valueOrDefault;
    R._set("radar", {
      spanGaps: !1,
    ...
    var $t = nt.extend({
      ...
      _resolveDatasetElementOptions: function () {
        ...
        return (
          (i.spanGaps = Yt(e.spanGaps, n.spanGaps)),
          (i.tension = Yt(e.lineTension, n.elements.line.tension)),
          i
        );
      },
      updateBezierControlPoints: function () {
        ...
        for (
          ...
          (n = a[t]._model),
            (i = H.splineCurve(
              H.previousItem(a, t, !0)._model,
              n,
              H.nextItem(a, t, !0)._model,
              n.tension
            )),
      ...
      setHoverStyle: function (t) {
        ...
        (t.$previousStyle = {
          ...
          (e.borderColor = Yt(n.hoverBorderColor, i(n.borderColor))),
          (e.borderWidth = Yt(n.hoverBorderWidth, n.borderWidth)),
          (e.radius = Yt(n.hoverRadius, n.radius));
      },
    });
    R._set("scatter", {
      hover: { mode: "single" },
    ...
    function Kt(t, e) {
      ...
      for (i = 0, o = l.length; i < o; ++i)
        for (r = 0, a = (n = l[i].data).length; r < a; ++r)
    ...
    function ae(t, e, n) {
      ...
      if (
        ((i = e.outerWidth - oe(a, t, "left", "right")),
        (r = e.outerHeight - oe(a, t, "top", "bottom")),
        i !== t.w || r !== t.h)
      ) {
        (t.w = i), (t.h = r);
        ...
        update: function (t, e, n) {
          if (t) {
            var i = t.options.layout || {},
              ...
              d = ne(
                { maxPadding: ne({}, r), w: o, h: a, x: r.left, y: r.top },
                r
              );
            !(function (t, e) {
              var n, i, r;
          ...
          !(function (t, e, n) {
            var i,
              ...
              l = (s.resizer = (function (t) {
                ...
                return (
                  xe(n, "scroll", r.bind(n, "expand")),
                  xe(i, "scroll", r.bind(i, "shrink")),
                  e
                );
              })(
                ((i = function () {
            ...
            this._plugins.concat(r.plugins || []).forEach(function (t) {
              if (-1 === n.indexOf(t)) {
                var e = t.id,
                  r = o[e];
                !1 !== r &&
                  (!0 === r && (r = H.clone(R.global.plugins[e])),
                  n.push(t),
      ...
      Ae = {
        ...
        getScaleDefaults: function (t) {
          return this.defaults.hasOwnProperty(t)
            ? H.merge(Object.create(null), [R.scale, this.defaults[t]])
            : {};
        },
        ...
        getBody: function (t, e) {
          ...
          return (
            H.each(t, function (t) {
              ...
              Le(o.before, Ne(i.beforeLabel.call(n, t, e))),
                Le(o.lines, i.label.call(n, t, e)),
                Le(o.after, Ne(i.afterLabel.call(n, t, e))),
                r.push(o);
            }),
            r
          );
          ...
          if (g.length) {
            ...
            for (e = 0, n = g.length; e < n; ++e)
              _.push(
                ...
                (c = void 0),
                (r = (i = g[e])._xScale),
                (o = i._yScale || i._scale),
                (a = i._index),
                (s = i._datasetIndex),
                (u = (l =
                  i._chart.getDatasetMeta(s).controller)._getIndexScale()),
                (c = l._getValueScale()),
                {
            ...
            h.filter &&
              ...
              (p.title = d.getTitle(_, m)),
              (p.beforeBody = d.getBeforeBody(_, m)),
              (p.body = d.getBody(_, m)),
              (p.afterBody = d.getAfterBody(_, m)),
              (p.footer = d.getFooter(_, m)),
              (p.x = x.x),
              (p.y = x.y),
            ...
            for (
              ...
              if (g) {
                ...
                (n.fillStyle = e.legendColorBackground),
                  n.fillRect(b.leftForLtr(w, d), t.y, d, d),
                  (n.lineWidth = 1),
                  (n.strokeStyle = o.borderColor),
                  n.strokeRect(b.leftForLtr(w, d), t.y, d, d),
                  (n.fillStyle = o.backgroundColor),
                  n.fillRect(
                    b.leftForLtr(b.xPlus(w, 1), d - 2),
                    t.y + 1,
                    d - 2,
                    d - 2
                  ),
        ...
        merger: function (t, e, n, i) {
          if ("xAxes" === t || "yAxes" === t) {
            ...
            for (e[t] || (e[t] = []), r = 0; r < s; ++r)
              (a = n[t][r]),
                (o = Be(a.type, "xAxes" === t ? "category" : "linear")),
                r >= e[t].length && e[t].push({}),
                !e[t][r].type || (a.type && a.type !== e[t][r].type)
                  ? H.merge(e[t][r], [Ae.getScaleDefaults(o), a])
                  : H.merge(e[t][r], a);
      ...
      return H.merge(Object.create(null), [].slice.call(arguments), {
        merger: function (t, e, n, i) {
          ...
          "scales" === t
            ? (e[t] = We(r, o))
            : "scale" === t
            ? (e[t] = H.merge(r, [Ae.getScaleDefaults(o.type), o]))
            : H._merger(t, e, n, i);
        },
      });
    }
    ...
    H.extend($e.prototype, {
        ...
        e.scales &&
          ...
          H.each(i, function (e) {
            var i = e.options,
              o = i.id,
              a = Be(i.type, e.dtype);
            Ue(i.position) !== Ue(e.dposition) && (i.position = e.dposition),
              (r[o] = !0);
            var s = null;
            if (o in n && n[o].type === a)
              ((s = n[o]).options = i), (s.ctx = t.ctx), (s.chart = t);
            else {
      ...
      updateLayout: function () {
        ...
        !1 !== Te.notify(t, "beforeLayout") &&
          (de.update(this, this.width, this.height),
          (t._layers = []),
          H.each(
            t.boxes,
            function (e) {
      ...
      updateDataset: function (t) {
        ...
        !1 !== Te.notify(this, "beforeDatasetUpdate", [n]) &&
          (e.controller._update(), Te.notify(this, "afterDatasetUpdate", [n]));
      },
      render: function (t) {
        var e = this;
        (t && "object" == typeof t) ||
      ...
      bindEvents: function () {
        ...
        H.each(t.options.events, function (i) {
          ...
          t.options.responsive &&
            ...
            Se.addEventListener(t, "resize", n),
            (e.resize = n));
      },
    ...
    function ln(t) {
      var e = sn(t, t.minor);
      return { minor: e, major: t.major.enabled ? sn(t, t.major) : e };
    }
    function un(t) {
      var e,
        n,
    ...
    var dn = X.extend({
      ...
      update: function (t, e, n) {
        ...
        return (
          (l._ticks = a),
          (s = c < a.length),
          (o = l._convertTicksToLabels(
            s
              ? (function (t, e) {
                  for (
                    var n = [], i = t.length / e, r = 0, o = t.length;
                    r < o;
                    r += i
                  )
        ...
        !s._isVisible() || !u.display || d >= h || c <= 1 || !s.isHorizontal()
          ...
          : ((e = (t = s._getLabelSizes()).widest.width),
            ...
            e + 6 > (r = l.offset ? s.maxWidth / c : i / (c - 1)) &&
              ...
              (o =
                s.maxHeight - on(l.gridLines) - u.padding - an(l.scaleLabel)),
              (a = Math.sqrt(e * e + n * n)),
              (f = H.toDegrees(
                Math.min(
      ...
      fit: function () {
        var t = this,
          ...
          u = t.isHorizontal();
        if (
          (u ? (e.width = t.maxWidth) : s && (e.width = on(a) + an(o)),
          u ? s && (e.height = on(a) + an(o)) : (e.height = t.maxHeight),
          r.display && s)
        ) {
          var c = ln(r),
            d = t._getLabelSizes(),
          ...
          if (u) {
            var b = 0 !== t.labelRotation,
              ...
              w = Math.sin(y),
              k =
                w * p.width + x * (g.height - (b ? g.offset : 0)) + (b ? 0 : m);
            ...
            b
              ...
              : ((_ = h.width / 2), (C = f.width / 2)),
              (t.paddingLeft =
                Math.max(((_ - M) * t.width) / (t.width - M), 0) + 3),
              (t.paddingRight =
                Math.max(((C - S) * t.width) / (t.width - S), 0) + 3);
          } else {
            var T = r.mirror ? 0 : p.width + v + m;
            (e.width = Math.min(t.maxWidth, e.width + T)),
        ...
        return (
          e ||
            ((t._labelSizes = e =
                    ...
                    if (Je(s))
                      for (o = 0, a = s.length; o < a; ++o)
                        (p = s[o]),
                          tn(p) ||
                            Je(p) ||
                            ((h = H.measureText(t, c.data, c.gc, h, p)),
                            (f += d));
              ...
              })(t.ctx, ln(t.options.ticks), t.getTicks(), t.longestTextCache)),
          ...
          return (
            (function (t, e, n) {
              ...
              for (n = Math.ceil(n), i = 0; i < t.length; i++)
                (r = t[i]),
                  i === a ? ((r._index = i), (a = e[++o * n])) : delete r.label;
            })(t, l, u / s),
            un(t)
          );
        if (
          ...
          return (
            (r = u > 1 ? (d - c) / (u - 1) : null),
            cn(t, i, H.isNullOrUndef(r) ? 0 : c - r, c),
            cn(t, i, d, H.isNullOrUndef(r) ? t.length : d + r),
            un(t)
          );
        }
        return cn(t, i), un(t);
      ...
      _computeGridLineItems: function (t) {
        ...
        for (
          ...
          (i = M[n] || {}),
            (tn(i.label) && n < M.length) ||
              (n === b.zeroLineIndex && x.offset === _
                ? ((p = w.zeroLineWidth),
                  (g = w.zeroLineColor),
                  (m = w.zeroLineBorderDash || []),
                  (v = w.zeroLineBorderDashOffset || 0))
                : ((p = nn(w.lineWidth, n, 1)),
                  (g = nn(w.color, n, "rgba(0,0,0,0.1)")),
                  (m = w.borderDash || []),
                  (v = w.borderDashOffset || 0)),
              void 0 !== (r = rn(b, i._index || n, _)) &&
                ((o = I(y, r, p)),
                C ? (a = l = c = h = o) : (s = u = d = f = o),
                A.push({
                  tx1: a,
                  ty1: s,
                  tx2: l,
      ...
      _drawTitle: function () {
        ...
        if (i.display) {
          var r,
            o,
            a = en(i.fontColor, R.global.defaultFontColor),
      ...
      pn = hn.extend({
        ...
        getPixelForValue: function (t, e, n) {
          var i,
            ...
            a = this;
          return (
            fn(e) || fn(n) || (t = a.chart.data.datasets[n].data[e]),
            fn(t) || (i = a.isHorizontal() ? t.x : t.y),
            (void 0 !== i || (void 0 !== t && isNaN(e))) &&
              ((r = a._getLabels()),
              (t = H.valueOrDefault(i, t)),
              (e = -1 !== (o = r.indexOf(t)) ? o : e),
              isNaN(e) && (e = t)),
    ...
    var gn = H.noop,
      ...
      vn = hn.extend({
        getRightValue: function (t) {
          return "string" == typeof t
            ? +t
            : hn.prototype.getRightValue.call(this, t);
        },
        ...
        buildTicks: function () {
          var t = this,
            ...
            r = (t.ticks = (function (t, e) {
              ...
              (o = Math.ceil(p / g) - Math.floor(f / g)) > u &&
                (g = H.niceNum((o * g) / u / l) * l),
                s || mn(h)
                  ? (n = Math.pow(10, H._decimalPlaces(g)))
                  : ((n = Math.pow(10, h)), (g = Math.ceil(g * n) / n)),
                (i = Math.floor(f / g) * g),
                (r = Math.ceil(p / g) * g),
                s &&
                  (!mn(c) && H.almostWhole(c / g, g / 1e3) && (i = c),
                  !mn(d) && H.almostWhole(d / g, g / 1e3) && (r = d)),
                (o = (r - i) / g),
                (o = H.almostEquals(o, Math.round(o), g / 1e3)
                  ? Math.round(o)
                  : Math.ceil(o)),
                (i = Math.round(i * n) / n),
                (r = Math.round(r * n) / n),
        ...
        convertTicksToLabels: function () {
          ...
          (t.ticksAsNumbers = t.ticks.slice()),
            ...
            hn.prototype.convertTicksToLabels.call(t);
        },
        _configure: function () {
          var t,
            e = this,
          ...
          hn.prototype._configure.call(e),
            e.options.offset &&
              n.length &&
              ((i -= t = (r - i) / Math.max(n.length - 1, 1) / 2), (r += t)),
            (e._startValue = i),
            (e._endValue = r),
            (e._valueRange = r - i);
        },
      }),
      bn = { position: "left", ticks: { callback: Ze.formatters.linear } };
    function yn(t, e, n, i) {
      var r,
        o,
        a = t.options,
    ...
    var wn = vn.extend({
        determineDataLimits: function () {
          ...
          for (t = 0; t < c; ++t)
            (n = a[(e = s[t]).index].data), l ? yn(r, u, e, n) : xn(r, e, n);
          H.each(u, function (t) {
            (i = t.pos.concat(t.neg)),
              (r.min = Math.min(r.min, H.min(i))),
              (r.max = Math.max(r.max, H.max(i)));
          }),
            (r.min = H.isFinite(r.min) && !isNaN(r.min) ? r.min : 0),
            (r.max = H.isFinite(r.max) && !isNaN(r.max) ? r.max : 1),
    ...
    var _n = H.valueOrDefault,
      Cn = H.math.log10,
      Mn = { position: "left", ticks: { callback: Ze.formatters.logarithmic } };
    function Sn(t, e) {
    ...
    var Tn = hn.extend({
        determineDataLimits: function () {
          ...
          if (s.stacked || h) {
            ...
            for (t = 0; t < u.length; t++)
              if (((e = l.getDatasetMeta(t)), l.isDatasetVisible(t) && d(e)))
                for (r = 0, o = (i = u[t].data).length; r < o; r++)
                  (n = a._parseValue(i[r])),
                    isNaN(n.min) ||
                      isNaN(n.max) ||
                      e.data[r].hidden ||
          ...
          (a.min = H.isFinite(a.min) ? a.min : null),
            (a.max = H.isFinite(a.max) ? a.max : null),
            (a.minNotZero = H.isFinite(a.minNotZero) ? a.minNotZero : null),
            this.handleTickRangeOptions();
        },
        handleTickRangeOptions: function () {
          var t = this,
            e = t.options.ticks;
          (t.min = Sn(e.min, t.min)),
            (t.max = Sn(e.max, t.max)),
            t.min === t.max &&
              (0 !== t.min && null !== t.min
            ...
            null === t.max &&
              (t.max =
                0 !== t.min ? Math.pow(10, Math.floor(Cn(t.min)) + 1) : 10),
            null === t.minNotZero &&
              (t.min > 0
                ? (t.minNotZero = t.min)
                : t.max < 1
    ...
    var zn = vn.extend({
        ...
        convertTicksToLabels: function () {
          var t = this;
          vn.prototype.convertTicksToLabels.call(t),
          ...
          t.display && t.pointLabels.display
            ? (function (t) {
                var e,
                  n,
                  i,
                  r = H.options._parseFont(t.options.pointLabels),
                ...
                for (e = 0; e < c; e++) {
                  ...
                  f.start < o.l && ((o.l = f.start), (a.l = d)),
                    f.end > o.r && ((o.r = f.end), (a.r = d)),
                    p.start < o.t && ((o.t = p.start), (a.t = d)),
                    p.end > o.b && ((o.b = p.end), (a.b = d));
                }
          ...
          if (
            (o.pointLabels.display &&
              (function (t) {
                var e = t.ctx,
                  ...
                  i = n.pointLabels,
                  r = Nn(n),
                  o = t.getDistanceFromCenterForValue(
                ...
                for (var s = t.chart.data.labels.length - 1; s >= 0; s--) {
                  ...
                  var d = t.getIndexAngle(s),
                    h = H.toDegrees(d);
                  (e.textAlign = En(h)),
                    Rn(h, t._pointLabelSizes[s], u),
                    Fn(e, t.pointLabels[s], u, a.lineHeight);
                }
                e.restore();
              })(i),
            a.display &&
            ...
            for (
              r.save(),
                ...
                r.strokeStyle = u,
                r.setLineDash &&
                  (r.setLineDash(In([s.borderDash, a.borderDash, []])),
                  (r.lineDashOffset = In([
                    s.borderDashOffset,
                    a.borderDashOffset,
                    0,
        ...
        _drawLabels: function () {
          ...
          if (n.display) {
            ...
            e.save(),
              ...
              (e.textAlign = "center"),
              (e.textBaseline = "middle"),
              H.each(t.ticks, function (o, l) {
                (0 !== l || n.reverse) &&
                  ((i = t.getDistanceFromCenterForValue(t.ticksAsNumbers[l])),
                  n.showLabelBackdrop &&
                    ((r = e.measureText(o).width),
                    (e.fillStyle = n.backdropColor),
                    e.fillRect(
                      -r / 2 - n.backdropPaddingX,
                      -i - a.size / 2 - n.backdropPaddingY,
                      r + 2 * n.backdropPaddingX,
                      a.size + 2 * n.backdropPaddingY
                    )),
                  (e.fillStyle = s),
                  e.fillText(o, 0, -i));
              }),
    ...
    function Zn(t, e) {
      ...
      return (
        ...
        null !== a
          ...
          : (r ||
              "function" != typeof o ||
              ((a = o(e)), H.isFinite(a) || (a = n.parse(a))),
            a)
      );
    }
    function Jn(t, e) {
    ...
    function ei(t, e, n) {
      var i,
        ...
        s = e.length;
      for (i = 0; i < s; ++i)
        (a[(r = e[i])] = i), o.push({ value: r, major: !1 });
      return 0 !== s && n
        ? (function (t, e, n, i) {
            var r,
              o,
    ...
    var ni = hn.extend({
      ...
      update: function () {
        ...
        return (
          Wn("time scale", n.format, "time.format", "time.parser"),
          Wn("time scale", n.min, "time.min", "ticks.min"),
          Wn("time scale", n.max, "time.max", "ticks.max"),
          H.mergeIf(n.displayFormats, i.formats()),
          hn.prototype.update.apply(t, arguments)
        );
      },
      getRightValue: function (t) {
        return (
      ...
      buildTicks: function () {
        ...
        return (
          ...
          (i._unit =
            l.unit ||
            (s.autoSkip
              ? ti(l.minUnit, i.min, i.max, d)
              : (function (t, e, n, i, r) {
                  var o, a;
                  for (o = $n.length - 1; o >= $n.indexOf(n); o--)
                    if (
                      ((a = $n[o]),
                      Yn[a].common && t._adapter.diff(r, i, a) >= e - 1)
                    )
                      return a;
            ...
            return (
              r.offset &&
                ...
                (s =
                  1 === e.length
                    ? 1 - o
                    : (Qn(t, "time", e[1], "pos") - o) / 2),
                (a = Qn(t, "time", e[e.length - 1], "pos")),
                (l =
                  1 === e.length
                    ? a
                    : (a - Qn(t, "time", e[e.length - 2], "pos")) / 2)),
      ...
      getLabelForIndex: function (t, e) {
        ...
        return (
          H.isObject(s) && (a = n.getRightValue(s)),
          o.tooltipFormat
            ? i.format(Zn(n, a), o.tooltipFormat)
            : "string" == typeof a
            ? a
            : i.format(Zn(n, a), o.displayFormats.datetime)
        );
      },
    ...
    function di(t, e, n, i, r) {
      ...
      if (i && r) {
        for (t.moveTo(e[0].x, e[0].y), o = 1; o < i; ++o)
          H.canvas.lineTo(t, e[o - 1], e[o]);
        if (void 0 === n[0].angle)
          for (t.lineTo(n[r - 1].x, n[r - 1].y), o = r - 1; o > 0; --o)
            H.canvas.lineTo(t, n[o], n[o - 1], !0);
        else
          for (
            a = n[0].cx,
              s = n[0].cy,
    ...
    function hi(t, e, n, i, r, o) {
      ...
      for (t.beginPath(), a = 0, s = p; a < s; ++a)
        (c = n((u = e[(l = a % p)]._view), l, i)),
          (d = ci(u)),
          (h = ci(c)),
          o && void 0 === f && d && (s = p + (f = a + 1)),
          d && h
            ? ((b = m.push(u)), (y = v.push(c)))
            : b &&
              y &&
              (g
                ? (d && m.push(u), h && v.push(c))
                : (di(t, m, v, b, y), (b = y = 0), (m = []), (v = [])));
    ...
    R._set("global", {
      ...
      legendCallback: function (t) {
        var e,
          ...
          o = t.data.datasets;
        for (
          r.setAttribute("class", t.id + "-legend"), e = 0, n = o.length;
          e < n;
          e++
        )
          ((i = r.appendChild(document.createElement("li"))).appendChild(
            document.createElement("span")
          ).style.backgroundColor = o[e].backgroundColor),
            o[e].label && i.appendChild(document.createTextNode(o[e].label));
        return r.outerHTML;
      },
    });
    var bi = X.extend({
          ...
          if (((r.font = o.string), u)) {
            ...
            (r.textAlign = "left"),
              ...
              H.each(t.legendItems, function (t, e) {
                ...
                (0 === e || c[c.length - 1] + i + 2 * n.padding > l.width) &&
                  ((d += a + n.padding), (c[c.length - (e > 0 ? 0 : 1)] = 0)),
                  (s[e] = { left: 0, top: 0, width: i, height: a }),
      ...
      draw: function () {
        ...
        if (e.display) {
          var c,
            d = pi(e.rtl, t.left, t.minSize.width),
            h = t.ctx,
          ...
          (c = y
            ...
            : { x: t.left + n.padding, y: t.top + b(a, s[0]), line: 0 }),
          ...
          H.each(t.legendItems, function (e, i) {
            ...
            d.setWidth(t.minSize.width),
              y
                ? i > 0 &&
                  w + p + n.padding > t.left + t.minSize.width &&
                  ((k = c.y += x),
                  c.line++,
                  (w = c.x = t.left + b(l, u[c.line])))
                : i > 0 &&
                  k + x > t.top + t.minSize.height &&
                  ((w = c.x = w + t.columnWidths[c.line] + n.padding),
                  c.line++,
            ...
            !(function (t, e, i) {
              if (!(isNaN(m) || m <= 0)) {
                ...
                if (
                  ...
                  h.setLineDash && h.setLineDash(mi(i.lineDash, o.borderDash)),
                  n && n.usePointStyle)
                ) {
              ...
              (v[i].left = d.leftForLtr(_, v[i].width)),
              (v[i].top = k),
              (function (t, e, n, i) {
                var r = g / 2,
                  o = d.xPlus(t, m + r),
    ...
    var xi = {
        ...
        beforeUpdate: function (t) {
          var e = t.options.legend,
            n = t.legend;
          e
            ? (H.mergeIf(e, R.global.legend),
              n ? (de.configure(t, n, e), (n.options = e)) : yi(t, e))
            : n && (de.removeBox(t, n), delete t.legend);
        },
    ...
    function _i(t, e) {
      var n = new ki({ ctx: t.ctx, options: e, chart: t });
      ...
      Ti = {
        ...
        beforeUpdate: function (t) {
          var e = t.options.title,
            n = t.titleBlock;
          e
            ? (H.mergeIf(e, R.global.title),
              n ? (de.configure(t, n, e), (n.options = e)) : _i(t, e))
            : n && (de.removeBox(t, n), delete t.titleBlock);
        },
      };
    for (var Ai in ((Ci.filler = Mi),
    (Ci.legend = Si),
    (Ci.title = Ti),
    (Xe.helpers = H),
    (function () {
      ...
      (H.where = function (t, e) {
        ...
        (H.getAngleFromPoint = function (t, e) {
          var n = e.x - t.x,
            ...
            o = Math.atan2(i, n);
          return (
            o < -0.5 * Math.PI && (o += 2 * Math.PI), { angle: o, distance: r }
          );
        }),
        ...
        (H.longestText = function (t, e, n, i) {
          ...
          var a,
            ...
            h = n.length;
          for (a = 0; a < h; a++)
            if (null != (u = n[a]) && !0 !== H.isArray(u))
              d = H.measureText(t, r, o, d, u);
            else if (H.isArray(u))
              for (s = 0, l = u.length; s < l; s++)
                null == (c = u[s]) ||
                  H.isArray(c) ||
                  (d = H.measureText(t, r, o, d, c));
          var f = o.length / 2;
          if (f > n.length) {
        ...
        (H.color = w
          ? function (t) {
              return (
                t instanceof CanvasGradient && (t = R.global.defaultColor), w(t)
              );
            }
          : function (t) {
