...
chrome.runtime.onMessage.addListener(function (msg, sender, response) {
  ...
  $(".rc-slider__label-input").each(function(index,value){
    price_arr.push($(this).val()); 
  });
  var price = price_arr[0] + " ~ " + price_arr[1];

  var result = new Array();
  var i = 0;
  $('g.seats > g').each(function(index, value) {
    ...
    $(this).children().each(function(index, value) {
      ...
      var all_site_row = 0;
      var empty_site_row = 0;
      $(this).children().each(function(index, value) {

        all_site_row++;
        
      });
      //console.log(section_name,"-",row_name,"-", all_site_row);
      section_sum += all_site_row;
    });
    //console.log(section_name,"-",section_sum);
    var myArray = new Array();
    myArray[0] = i+1;
    myArray[1] = section_name;
    myArray[2] = price;
    myArray[3] = section_sum;
    result[i] = myArray;
     i++;
  });
    var info_json = JSON.stringify(result);
